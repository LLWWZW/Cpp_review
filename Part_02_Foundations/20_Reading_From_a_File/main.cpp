...
void file_open_testing()
{
    ...
    std::fstream my_file;
    my_file.open("C:\\Users\\zhoul\\OneDrive\\Desktop\\uda_cpp\\Cpp_review\\20_Reading_From_a_File\\files\\1.board");
...
{
    std::fstream my_file("C:\\Users\\zhoul\\OneDrive\\Desktop\\uda_cpp\\Cpp_review\\20_Reading_From_a_File\\files\\1.board");
    if (my_file)
    {
