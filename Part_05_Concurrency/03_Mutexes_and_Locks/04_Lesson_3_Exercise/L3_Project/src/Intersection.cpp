...
{
    // L3.3 : Ensure that the text output locks the console as a shared resource. Use the mutex _mtxCout you have added
    // to the base class TrafficObject in the previous task. Make sure that in between the two calls to std-cout at the
